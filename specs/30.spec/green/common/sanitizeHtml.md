...
- [ ] (Must, REQ-077 FR-01·FR-02) 위 §테스트 현황 (I14 효력면 동일성) 명령 → rc=0.
- [ ] (Must, REQ-077 FR-03) 위 §테스트 현황 (I14 변형 배터리 박제) 명령 → rc=0.
