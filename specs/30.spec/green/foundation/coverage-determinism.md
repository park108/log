...
> **관련 요구사항**: REQ-20260421-041, REQ-20260421-043, REQ-20260422-056
> **최종 업데이트**: 2026-04-22 (by inspector, REQ-20260422-056 흡수 — FR-08/FR-09/FR-10 3 불변식 증분 박제: coverage intermediate 잔재 robustness + pre-push 직전 실행 상태 독립성 + non-0 exit 귀인 경계)

> 참조 코드는 **식별자 우선, 라인 번호 보조**. 라인 번호는 스냅샷 (HEAD=690aa74 기준 REQ-041/043 박제, HEAD=996d25c 기준 REQ-056 증분 박제).
...
- **REQ 원문 (완료 처리)**:
  ...
  - `specs/60.done/2026/04/22/req/20260422-npm-test-determinism-and-branch-threshold-re-measurement.md` (REQ-20260422-056 — 본 세션 mv).
