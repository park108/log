...
- 템플릿: `specs/requirements/ready/yyyymmdd-template.md`.
...
5. **요구사항 문서화** — 후보마다 `specs/requirements/ready/yyyymmdd-template.md` 복사:
...
6. **보고** — `RULE-04` 블록 먼저. 상세: 소비 followup 내역(채택/병합/기각), 신규 요구사항 파일과 한 줄 요약.
