...
> SSoT: `specs/spec/blue/testing/toaster-visual-smoke-spec.md`
...
- SSoT spec: `specs/spec/blue/testing/toaster-visual-smoke-spec.md`
- 기원 요구사항: `specs/requirements/done/2026/04/18/20260418-css-modules-pilot-visual-checklist.md` (REQ-20260418-010, FR-01~06, NFR-01~03)
...
- 상위 정책 spec: `specs/spec/green/styles/css-modules-spec.md` §7 (DevTools 확인 항목)
